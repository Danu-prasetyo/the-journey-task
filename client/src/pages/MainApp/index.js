      ...
      <Container>
        ...
        <div className="row g-0 mt-5">
          <div className="col-md-11">
            <input type="text" placeholder="Search Your Journey" className="form-control border-0 p-3" onChange={(e) => setQuery(e.target.value)} />
          </div>
        ...
        <div className="row mt-5 pb-5">{!state.isLogin === true && <ContentCard data={finalResult} />}</div>
      </Container>
    </div>
  );
};
